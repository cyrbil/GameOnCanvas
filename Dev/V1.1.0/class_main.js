function game(p1,p2,p3,p4){
    ...
    game.prototype.ressources   = ({}); // object of string to load before launch main loop (preload) 
    game.prototype.canvas_inner = "Your web browser is to old to let you play. Please update or change it."; // between <canvas> balises
    game.prototype.scene        = null;  // scene that will be printed once game launch
    game.prototype.debug        = false; // display debug corner
    game.prototype.ie_support   = false; // use excanvas to make canvas work on ie
    ...
    game.prototype.version      = "V1.1.0 Release";
    ...
    game.prototype.ticker = function(tick, date, frames, that){
    ...
    game.prototype.display = function(){
        ...
        if(this.scene.constructor.name == "scene"){
            this.scene.tick();
    ...
    // draw credit ...
    game.prototype.draw_credit = function(){
...
function rectangle(x,y,w,h){ // simple object to manage coord
	...
	this.h = function(){return this.height;}
	this.x = function(){return this.left;}
	this.y = function(){return this.top;}
}